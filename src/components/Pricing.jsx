    ...
    <div name='pricing' className='w-full text-white my-24'>
        ...
        <div className='max-w-[1240px] mx-auto py-12'>
            <div className='text-center py-8 text-slate-300'>
                ...
                <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam maiores illum laudantium non id sint nostrum. Velit repellendus expedita ipsum.</p>
            </div>
                ...
                <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                    ...
                    <div>
                        ...
                        <div className='text-2xl'>
                            <p className='flex py-4'><i class="bi bi-check2 mr-5 text-green-600"></i>Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><i class="bi bi-check2 mr-5 text-green-600"></i>Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><i class="bi bi-check2 mr-5 text-green-600"></i>Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><i class="bi bi-check2 mr-5 text-green-600"></i>Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><i class="bi bi-check2 mr-5 text-green-600"></i>Lorem, ipsum dolor.</p>
